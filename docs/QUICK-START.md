...
These examples live in the repository-only `pepenium-examples` module. They are intended as runnable showcases and templates, not as reusable consumer artifacts.
