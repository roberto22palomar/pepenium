...
final class PepeniumReportHtmlRenderer {
    ...
    static String render(PepeniumHtmlReportWriter.ReportContext report) {
        ...
        html.append("<!DOCTYPE html><html lang=\"en\"><head><meta charset=\"UTF-8\">")
                ...
                .append(".section{margin-top:24px;} .section h2{margin:0 0 12px;font-size:18px;padding-left:12px;border-left:4px solid #8cb8ff;} .grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:16px;} .card,.panel,.artifact-card,.story-card{padding:18px;} .card strong{display:block;font-size:12px;text-transform:uppercase;letter-spacing:.05em;color:var(--muted);margin-bottom:8px;} .value{font-size:15px;line-height:1.45;word-break:break-word;}")
