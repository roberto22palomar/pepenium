...
final class PepeniumReportHtmlRenderer {
    ...
    static String render(PepeniumHtmlReportWriter.ReportContext report) {
        ...
        html.append("<!DOCTYPE html><html lang=\"en\"><head><meta charset=\"UTF-8\">")
                ...
                .append(".wrap{max-width:1240px;margin:0 auto;padding:28px 20px 48px;} .hero{position:relative;background:linear-gradient(135deg,#fcfeff 0,#f4f9ff 55%,#eef5fb 100%);border:1px solid var(--border);border-radius:28px;padding:28px;box-shadow:0 18px 40px rgba(24,39,75,.08);overflow:hidden;} .hero:before{content:'';position:absolute;inset:-80px auto auto -40px;width:220px;height:220px;border-radius:999px;background:radial-gradient(circle,#d7e9ff 0,rgba(215,233,255,0) 70%);} .hero:after{content:'';position:absolute;inset:auto -60px -80px auto;width:240px;height:240px;border-radius:999px;background:radial-gradient(circle,#e6f4ea 0,rgba(230,244,234,0) 72%);} .hero-top,.metrics{position:relative;z-index:1;} .hero-top{display:flex;justify-content:space-between;gap:16px;align-items:flex-start;flex-wrap:wrap;} .hero h1{margin:10px 0 8px;font-size:31px;line-height:1.1;letter-spacing:-.03em;color:var(--hero-ink);} .hero-meta{display:flex;flex-wrap:wrap;gap:14px;margin-top:10px;font-size:14px;color:var(--muted);} .hero-actions{display:flex;gap:10px;flex-wrap:wrap;} .brand{display:inline-flex;align-items:flex-start;gap:14px;margin-bottom:8px;} .brand-mark{padding:10px 12px;border-radius:18px;background:linear-gradient(145deg,#0f2942 0,#1a4f7d 100%);box-shadow:0 12px 26px rgba(15,41,66,.18);} .brand-mark pre{margin:0;background:transparent;color:#eef7ff;padding:0;font-size:9px;line-height:1.05;letter-spacing:.04em;font-family:Consolas,Menlo,monospace;overflow:visible;} .brand-copy{display:flex;flex-direction:column;gap:4px;} .brand-kicker{font-size:11px;text-transform:uppercase;letter-spacing:.14em;color:var(--accent);font-weight:800;} .brand-title{font-size:14px;font-weight:800;color:var(--hero-ink);} .brand-subtitle{font-size:12px;color:var(--muted);max-width:420px;line-height:1.45;}")
        ...
        html.append("<section class=\"hero\"><div class=\"hero-top\"><div><div class=\"brand\"><div class=\"brand-mark\"><pre>")
                .append(PepeniumReportSupport.escapeHtml(pepeniumAscii()))
                .append("</pre></div><div class=\"brand-copy\"><div class=\"brand-kicker\">Pepenium Report</div><div class=\"brand-title\">Automation evidence, condensed for humans</div><div class=\"brand-subtitle\">A cleaner execution story on top of the raw timeline, so long runs stay readable without losing drill-down detail.</div></div></div><span class=\"status ")
    ...
    private static String pepeniumAscii() {
        return " ___  ___  ___ \n"
                + "| _ \\/ __>| _ \\\n"
                + "|  _/\\__ \\|  _/\n"
                + "|_|  <___/|_|  ";
